...
- The **Provider pattern** makes data available to many components in an application without manually passing it down through each level of the component tree (avoiding "prop drilling"). 
- It uses a **Context** object that wraps a parent component, and any component within that provider can consume the data directly.
